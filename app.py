...
def save_trip_receipt(
    receipt_file,
    trip_id
):
    """
    Valida e salva um comprovante de passeio.

    Retorna:
        caminho_publico, erro, status_http
    """
...
@app.route(
    "/admin/passeios/inscricoes/"
    "<int:registration_id>/comprovante",
    methods=["POST"]
)
@admin_required_page
def admin_upload_trip_receipt(
    registration_id
):
